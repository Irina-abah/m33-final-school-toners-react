...
const Toner = ({ toner, toners, onChangeQuantity, isSuccess, setIsSuccess}) => {
  ...
  const tonerWrapperClassName = (toners.length > 1) ? "toner-info" : "";
 
  return (
    <li>
      <div className={tonerWrapperClassName}>
